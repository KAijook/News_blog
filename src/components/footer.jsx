  ...
  return <footer className="py-10 px-4 sm:px-6 lg:px-8 font-inter relative overflow-hidden ">
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10">
        ...
        <nav className="mb-6 w-full">
          <ul className="flex flex-wrap list-none justify-center  gap-x-[16px] gap-y-[4px] text-base font-[500] text-gray-600 dark:text-gray-400">
            {navLinks.map(link => <li key={link.name}>
                <a href={link.href} className="no-underline text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-[#fff] transition-all duration-300 relative after:absolute after:left-0 after:bottom-0 after:h-0.5 after:w-0 after:bg-gray-900 dark:after:bg-white after:transition-all after:duration-300 hover:after:w-full">
                  {link.name}
                </a>
              </li>)}
          </ul>
        ...
        <div className="my-6 flex flex-wrap justify-center gap-[16px] text-sm">
